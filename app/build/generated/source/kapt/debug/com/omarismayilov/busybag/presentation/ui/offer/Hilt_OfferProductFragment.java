...
public abstract class Hilt_OfferProductFragment<VB extends ViewBinding> extends BaseFragment<VB> implements GeneratedComponentManagerHolder {
  ...
  Hilt_OfferProductFragment(Function1<? super LayoutInflater, ? extends VB> bindingInflater) {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((OfferProductFragment_GeneratedInjector) this.generatedComponent()).injectOfferProductFragment(UnsafeCasts.<OfferProductFragment>unsafeCast(this));
    }
  }
