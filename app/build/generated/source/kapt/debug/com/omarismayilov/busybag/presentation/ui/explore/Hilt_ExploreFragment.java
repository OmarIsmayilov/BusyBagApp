...
public abstract class Hilt_ExploreFragment<VB extends ViewBinding> extends BaseFragment<VB> implements GeneratedComponentManagerHolder {
  ...
  Hilt_ExploreFragment(Function1<? super LayoutInflater, ? extends VB> bindingInflater) {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((ExploreFragment_GeneratedInjector) this.generatedComponent()).injectExploreFragment(UnsafeCasts.<ExploreFragment>unsafeCast(this));
    }
  }
