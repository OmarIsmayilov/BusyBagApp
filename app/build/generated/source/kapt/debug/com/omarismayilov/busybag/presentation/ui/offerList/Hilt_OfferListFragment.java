...
public abstract class Hilt_OfferListFragment<VB extends ViewBinding> extends BaseFragment<VB> implements GeneratedComponentManagerHolder {
  ...
  Hilt_OfferListFragment(Function1<? super LayoutInflater, ? extends VB> bindingInflater) {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((OfferListFragment_GeneratedInjector) this.generatedComponent()).injectOfferListFragment(UnsafeCasts.<OfferListFragment>unsafeCast(this));
    }
  }
