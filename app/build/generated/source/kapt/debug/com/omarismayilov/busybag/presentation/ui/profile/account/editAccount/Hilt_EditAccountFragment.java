...
public abstract class Hilt_EditAccountFragment<VB extends ViewBinding> extends BaseFragment<VB> implements GeneratedComponentManagerHolder {
  ...
  Hilt_EditAccountFragment(Function1<? super LayoutInflater, ? extends VB> bindingInflater) {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((EditAccountFragment_GeneratedInjector) this.generatedComponent()).injectEditAccountFragment(UnsafeCasts.<EditAccountFragment>unsafeCast(this));
    }
  }
