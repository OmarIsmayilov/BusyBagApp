...
public final class FavoriteDAO_Impl implements FavoriteDAO {
  ...
  public FavoriteDAO_Impl(RoomDatabase __db) {
    ...
    this.__insertionAdapterOfFavoriteDTO = new EntityInsertionAdapter<FavoriteDTO>(__db) {
      ...
      public String createQuery() {
        return "INSERT OR ABORT INTO `favorite_product` (`id`,`title`,`rating`,`price`,`originalPrice`,`discount`,`image`) VALUES (?,?,?,?,?,?,?)";
      }
  ...
  @Override
  public void addFav(final FavoriteDTO product) {
  ...
  @Override
  public void deleteFav(final FavoriteDTO product) {
    __db.assertNotSuspendingTransaction();
    __db.beginTransaction();
    try {
  ...
  @Override
  public List<FavoriteDTO> getFav() {
