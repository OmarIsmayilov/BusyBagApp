...
public final class FavoriteDB_Impl extends FavoriteDB {
  ...
  protected SupportSQLiteOpenHelper createOpenHelper(DatabaseConfiguration configuration) {
    final SupportSQLiteOpenHelper.Callback _openCallback = new RoomOpenHelper(configuration, new RoomOpenHelper.Delegate(1) {
      ...
      public void createAllTables(SupportSQLiteDatabase _db) {
        ...
        _db.execSQL("INSERT OR REPLACE INTO room_master_table (id,identity_hash) VALUES(42, '2fc4d6a02c782980522470f63e74b3e1')");
      }
      ...
      public RoomOpenHelper.ValidationResult onValidateSchema(SupportSQLiteDatabase _db) {
        ...
        if (! _infoFavoriteProduct.equals(_existingFavoriteProduct)) {
          return new RoomOpenHelper.ValidationResult(false, "favorite_product(com.omarismayilov.busybag.data.local.dto.FavoriteDTO).\n"
                  + " Expected:\n" + _infoFavoriteProduct + "\n"
                  + " Found:\n" + _existingFavoriteProduct);
        }
        return new RoomOpenHelper.ValidationResult(true, null);
      }
    }, "2fc4d6a02c782980522470f63e74b3e1", "141072539a1334c6d3f6ee3a944e9b0c");
  ...
  protected InvalidationTracker createInvalidationTracker() {
    ...
    return new InvalidationTracker(this, _shadowTablesMap, _viewTables, "favorite_product");
  }
